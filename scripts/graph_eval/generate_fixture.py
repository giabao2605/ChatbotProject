...
DOCUMENTS = (
    ...
    {"key": "assembly_v2", "filename": "graph_eval_assembly_v2.md", "doc_number": "GRAPH-EVAL-ASM-001", "version": 2, "department": "Technical", "site": FIXTURE_SITE, "security_level": "internal", "state": "current", "title": "Assembly graph v2", "body": "Cụm GRAPH-EVAL-ASM-001 dùng danh mục vật tư có provenance SQL. Cụm GRAPH-EVAL-ASM-001 áp dụng cho GRAPH-EVAL-PART-A."},
