...
def _cases() -> list[dict]:
    ...
    return [
        ...
        {"id": "crag-number-repair", "question": "Giá trị định mức CRAG-EVAL-NUM-001 là bao nhiêu?", "expected_outcome": "full_answer", "expected_keywords": ["1,500"], "requires_repair": True, "evaluation_draft_override": "Giá trị định mức là 1,501.", **_identity(), **_source(by_key["numbers"])},
        ...
        {"id": "crag-admin-exception", "question": "Theo tài liệu CRAG-EVAL-SECRET-001, chỉ trả lời đúng chuỗi mã cấu hình hạn chế bắt đầu bằng CRAG-EVAL-SECRET-, không diễn giải.", "expected_outcome": "full_answer", "expected_keywords": ["CRAG-EVAL-SECRET-RED"], "admin_exception": True, **_identity(roles=["admin"], sites=[FIXTURE_REMOTE_SITE], clearance="confidential"), **_source(by_key["restricted"])},
    ]
