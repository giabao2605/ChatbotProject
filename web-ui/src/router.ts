...
export const routes = [
  ...
  { path: "/access", name: "access", component: AccessView, meta: { roles: ["viewer", "uploader", "reviewer", "security_admin"] } },
  ...
  { path: "/analytics", name: "analytics", component: AnalyticsView, meta: { roles: ["reviewer", "admin", "platform_admin"] } },
