...
Citation của evidence đủ điều kiện phục vụ được so khớp theo tập canonical source identity duy nhất: nhiều chunk cùng một nguồn/trang được gộp, nhưng bất kỳ source identity khác expectation đều làm gate fail. Số document raw retrieval vẫn được giữ riêng trong telemetry.
