...
- The typed request execution mode is `production`, `evaluation`,
  `pilot_replay`, or `test` and is attached unchanged to every trace event.
  Evaluation, privacy-redacted pilot replay, and tests must identify themselves.
